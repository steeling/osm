...
func (s *validatingWebhookServer) run(port int, certificater *certificate.Certificate, stop <-chan struct{}) {
	...
	go func() {
		...
		cert, err := tls.X509KeyPair(certificater.CertChain, certificater.PrivateKey)
		if err != nil {
