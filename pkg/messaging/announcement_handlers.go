...
func WatchAndUpdateProxyBootstrapSecret(kubeClient kubernetes.Interface, msgBroker *Broker, stop <-chan struct{}) {
...
func WatchAndUpdateLogLevel(msgBroker *Broker, stop <-chan struct{}) {
	kubePubSub := msgBroker.GetKubeEventPubSub()
