...
import (
	...
	"github.com/openservicemesh/osm/pkg/messaging/events"
...
func GetEventHandlerFuncs(shouldObserve observeFilter, eventTypes EventTypes, msgBroker *Broker) cache.ResourceEventHandlerFuncs {
