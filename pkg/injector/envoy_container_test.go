...
var _ = Describe("Test functions creating Envoy bootstrap configuration", func() {
	...
	originalHealthProbes := bootstrap.HealthProbes{
		Liveness:  &bootstrap.HealthProbe{path: "/liveness", port: 81},
		Readiness: &bootstrap.HealthProbe{path: "/readiness", port: 82},
		Startup:   &bootstrap.HealthProbe{path: "/startup", port: 83},
	}
